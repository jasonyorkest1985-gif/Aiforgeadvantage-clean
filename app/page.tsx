...
export default function Home() {
  return (
    <main className="mx-auto flex w-full max-w-7xl flex-col px-5 pb-24 pt-6 sm:px-6 md:px-10 lg:px-14">
      <header className="mb-12 flex items-center justify-between rounded-2xl border border-[#00A3FF]/25 bg-gradient-to-r from-[#0A0F1E]/85 to-black/60 px-5 py-6 sm:px-8 backdrop-blur">
        <p className="text-2xl font-bold tracking-tight text-[#FF4D00] [text-shadow:0_0_18px_rgba(255,77,0,0.65)] sm:text-[28px] sm:[text-shadow:0_0_24px_rgba(255,77,0,0.7)]">
          AI Forge Advantage
        </p>
      ...
      <section className="hero-spotlight reveal rounded-3xl border border-[#00A3FF]/30 bg-gradient-to-b from-[#0A0F1E]/75 to-black/70 px-6 py-18 shadow-[0_24px_90px_-56px_rgba(0,163,255,0.55)] sm:px-10 sm:py-22 md:px-12 lg:px-16 lg:py-24 lg:shadow-[0_32px_130px_-60px_rgba(0,163,255,0.6)]">
        <p className="mb-8 inline-flex items-center rounded-full border border-[#FF4D00]/55 bg-[#FF4D00]/10 px-5 py-2 text-sm font-semibold uppercase tracking-[0.24em] text-[#FF4D00] [text-shadow:0_0_16px_rgba(255,77,0,0.6)]">
      ...
      <section className="reveal reveal-delay-1 mt-12 sm:mt-14">
        ...
        <div className="mt-10 grid gap-5 sm:gap-6 md:grid-cols-3">
          {[
            ...
            >
              <p className="text-base uppercase tracking-[0.16em] text-[#FF4D00] [text-shadow:0_0_14px_rgba(255,77,0,0.7)]">
                Real Cost
              </p>
              <p className="mt-4 text-2xl leading-relaxed font-medium text-white/95">
                {stat}
              </p>
            </div>
          ))}
      ...
      <section className="reveal reveal-delay-2 mt-12 sm:mt-14">
        ...
        <div className="mt-10 grid gap-6 sm:gap-7 lg:grid-cols-2">
          <article className="cinematic-hover rounded-2xl border border-[#FF4D00]/45 bg-gradient-to-b from-[#FF4D00]/14 to-black/55 p-8 [box-shadow:0_0_28px_-14px_rgba(255,77,0,0.82)] hover:-translate-y-1 hover:border-[#FF4D00]/80 sm:p-10 sm:[box-shadow:0_0_36px_-14px_rgba(255,77,0,0.95)]">
            ...
            <h3 className="text-4xl font-semibold text-white">AI Sidekick Bot</h3>
          ...
          <article className="cinematic-hover rounded-2xl border border-[#00A3FF]/45 bg-gradient-to-b from-[#0A0F1E]/60 to-black/55 p-8 [box-shadow:0_0_28px_-14px_rgba(0,163,255,0.82)] hover:-translate-y-1 hover:border-[#00A3FF]/80 sm:p-10 sm:[box-shadow:0_0_36px_-14px_rgba(0,163,255,0.95)]">
            ...
            <h3 className="text-4xl font-semibold text-white">Strategic Website</h3>
      ...
      <section className="reveal reveal-delay-3 mt-12 sm:mt-14">
        ...
        <div className="mt-10 grid gap-5 sm:gap-6 md:grid-cols-3">
          {[
            ...
            >
              <p className="text-sm uppercase tracking-[0.2em] text-[#FF4D00] [text-shadow:0_0_12px_rgba(255,77,0,0.6)]">
                Step {index + 1}
              </p>
              ...
              <h3 className="mt-5 text-3xl leading-tight font-medium text-white">
                {step.title}
              </h3>
            </div>
          ))}
      ...
      <footer className="reveal reveal-delay-3 mt-24 rounded-2xl border border-[#FF4D00]/25 bg-gradient-to-r from-black/80 to-[#0A0F1E]/60 px-8 py-10">
        ...
        <div className="mt-6 flex flex-col gap-3 text-lg text-white/72">
          <a
